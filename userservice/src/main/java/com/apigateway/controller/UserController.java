...
import com.apigateway.service.UserServiceInterface;
...
public class UserController {
    ...
    public ResponseEntity<UserRequest> getUser (@PathVariable(value = "id")Integer userId) throws JsonProcessingException {
        UserRequest user=userService.fetchUserByUserId(userId);
